...
function ClipboardList({ clipboardName, items, loading, dupGroups, onAddItem, onDeleteItem, onEditItem, onCopyItem, onCheckDuplicates, onClearDuplicates, }) {
